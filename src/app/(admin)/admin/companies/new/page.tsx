...
export default function AddCompanyPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Direct routing on submit ready for API connection
    ...
    <div className="max-w-4xl mx-auto space-y-4 sm:space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[var(--slate)]">
              Register a new corporate or distribution entity.
            </p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
        ...
        <Card className="border border-[var(--slate)]/15 bg-[var(--cream)] shadow-sm">
          ...
          <CardContent className="p-4 sm:p-5 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="space-y-1">
                ...
                <input
                  type="email"
                  name="email"
                  placeholder="info@alhaditraders.com"
              ...
              <div className="space-y-1">
                ...
                <input
                  type="text"
                  name="website"
                  placeholder="https://alhaditraders.com"
            ...
            <div className="space-y-1.5 pt-2">
              ...
              <div className="border-2 border-dashed border-[var(--slate)]/20 rounded-[var(--radius)] p-4 text-center bg-[var(--cream-dark)] hover:border-[var(--gold)]/50 transition-colors cursor-pointer">
                <Upload className="h-6 w-6 text-[var(--slate)] mx-auto mb-1" />
        ...
        <div className="flex flex-col-reverse sm:flex-row items-center justify-end gap-2.5 pt-2">
          <Link href="/admin/companies" className="w-full sm:w-auto">
            <Button
              type="button"
              variant="outline"
